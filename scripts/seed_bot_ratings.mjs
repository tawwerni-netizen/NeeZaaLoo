...
async function run() {
  ...
  for (const row of res.rows) {
    for (const game of games) {
      // Generate a bell-curve-like rating centered around 1500, varying from 800 to 2800
      let u = 0, v = 0;
      ...
      try {
        await pool.query(
          `INSERT INTO rating (player_id, game_id, rating_x100, rd_x100, vol_x10000, games_played)
           VALUES ($1, $2, $3, $4, 600, $5)
