...
export const FAQ_DATA: LocalizedFAQ = {
  ar: [
    ...
    },
    {
      ...
      answer: "نعم بالتأكيد. جميع ألعاب Nizalo هي مسابقات مهارة وذكاء بحتة (Pure Skill Games). النتيجة تعتمد كلياً على اختيارات اللاعب وتكتيكاته وسرعة بديهته ودقة قراراته، ولا توجد أي آليات روليت أو مراهنات أو حظ للمنصة.",
    ...
    },
    {
      ...
      answer: "إذا انتهت مهلة الـ 60 ثانية دون استجابة أو رفض الصديق الدعوة، تنتهي صلاحية التحدي تلقائياً ويتم فك تجميد رصيد الرهان فوراً في محفظتك.",
    ...
    // 7. المحفظة (Wallet)
    {
      ...
      answer: "تستخدم Nizalo نظام محاسبي مالي مزدوج القيد (Double-Entry Ledger) فائق الأمان. كل حركة رصيد—سواء كانت إيداعاً، أو حجز رهان لمباراة جارية، أو إضافة مكافأة فوز، أو سحب—تُقيد في سجل تدقيق مشفر غير قابل للتلاعب.",
