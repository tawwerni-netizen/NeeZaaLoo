...
const TOURNAMENT_SLIDES: TournSlide[] = [
  {
    ...
    titleAr: "كأس الأساطير الأسبوعي للنزالات الكبرى",
    titleEn: "World Blitz Grand Prix Arena",
  ...
  },
  {
    ...
    superAr: "بطولات نيزالو الكبرى · العب واكسب بجدارة",
    superEn: "GRAND NIZALO TOURNAMENTS",
    titleAr: "بطولة الإقصاء المباشر للمحترفين (Knockout Blitz)",
  ...
  },
  {
    ...
    superAr: "بطولات نيزالو الكبرى · العب واكسب بجدارة",
    superEn: "GRAND NIZALO TOURNAMENTS",
    titleAr: "تحدي النجوم الليلي المفتوح (Midnight Masters)",
    titleEn: "Midnight Masters Open Arena",
  ...
  },
  {
    ...
    superAr: "بطولات نيزالو الكبرى · العب واكسب بجدارة",
    superEn: "GRAND NIZALO TOURNAMENTS",
    titleAr: "نهائيات دوري نيزالو للمحترفين (Pro Finals)",
    titleEn: "Nizalo Pro League Grand Finals",
