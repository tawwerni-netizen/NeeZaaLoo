...
const PAGE_TEXTS: Record<SupportedLocale, {
  ...
  en: {
    ...
    metric4Sub: "Provably fair and purely skill-based",
    ...
    step2Desc: "Single-elimination brackets based on pure skill, monitored by Sentinel AI anti-cheat to guarantee 100% fair play.",
