                ...
                <div className={styles.rulesHeroBanner}>
                  ...
                  <div className={styles.rulesHeroOverlay}>
                    <span className={styles.rulesBadge}>
                      ...
                      {isRtl ? "القواعد المعتمدة رسمياً في نيزالو" : "Nizalo Official Sanctioned Standard"}
                    </span>
                    <h2 className={styles.rulesHeroHeading}>
                      {isRtl ? `قوانين وميكانيكا التحدي: ${gameName}` : `${gameName}: Sanctioned Tournament Rules`}
                    </h2>
                    <p className={styles.rulesHeroTagline}>
                      {isRtl
                        ? "معايير منافسة مهارية عادلة 100% بدون أي عنصر حظ. احتساب دقيق للوقت مع تطبيق بروتوكول مكافحة الغش المعتمد."
                        : "100% skill-based competitive layout with deterministic state engine and anti-cheat validation."}
                    </p>
                  </div>
                </div>
              </div>
