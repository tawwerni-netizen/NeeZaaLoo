...
export const WALLET_TRANSLATIONS: Record<SupportedLocale, WalletDictionary> = {
  ar: {
    ...
    tabWithdraw: "سحب رصيد USDT",
    tabHistory: "سجل العمليات المحاسبية",

    step1Title: "1. شبكة تحويل عملة USDT المعتمدة",
    step2Title: "2. باقة الإيداع وقوة الفوز التنافسية",
    step3Title: "3. إتمام التحويل عبر العنوان المخصص",

    coinSelectorTitle: "عملة الإيداع المعتمدة بالمنصة:",
    coinSelectorSubtitle: "عملة USDT مربوطة بالدولار الأمريكي 1:1 ($1.00 USD) بدون أي تذبذب في الأسعار",
  ...
  en: {
    ...
    tabWithdraw: "Withdraw USDT",
    tabHistory: "Ledger Audit History",

    step1Title: "1. Official USDT Transfer Network",
    step2Title: "2. Deposit Tier & Winning Power",
    step3Title: "3. Complete Transfer via Dedicated Address",

    coinSelectorTitle: "Official Platform Deposit Currency:",
    coinSelectorSubtitle: "USDT is pegged 1:1 with USD ($1.00 USD) with zero price fluctuation",
    coinUsdtName: "Tether (USDT)",
  ...
  es: {
    ...
    tabWithdraw: "Retirar USDT",
    tabHistory: "Historial Contable",

    step1Title: "1. Red de Transferencia Oficial USDT",
    step2Title: "2. Monto y Poder de Victoria",
    step3Title: "3. Transferencia a Dirección Dedicada",

    coinSelectorTitle: "Moneda de Depósito Oficial de la Plataforma:",
    coinSelectorSubtitle: "USDT está vinculada 1:1 con USD ($1.00 USD) sin variaciones de precio",
    coinUsdtName: "Tether (USDT)",
  ...
  fr: {
    ...
    tabWithdraw: "Retirer des USDT",
    tabHistory: "Historique Comptable",

    step1Title: "1. Réseau Officiel de Transfert USDT",
    step2Title: "2. Montant et Puissance de Victoire",
    step3Title: "3. Transfert via Adresse Dédiée",

    coinSelectorTitle: "Devise Officielle de Dépôt de la Plateforme :",
    coinSelectorSubtitle: "L'USDT est indexé 1:1 sur l'USD ($1.00 USD) sans variation de prix",
    coinUsdtName: "Tether (USDT)",
  ...
  hi: {
    ...
    tabWithdraw: "USDT निकालें",
    tabHistory: "लेज़र ऑडिट इतिहास",

    step1Title: "1. आधिकारिक USDT ट्रांसफर नेटवर्क",
    step2Title: "2. जमा राशि और जीत की शक्ति",
    step3Title: "3. समर्पित पते के माध्यम से ट्रांसफर",

    coinSelectorTitle: "प्लेटफ़ॉर्म की आधिकारिक जमा मुद्रा:",
    coinSelectorSubtitle: "USDT शून्य मूल्य उतार-चढ़ाव के साथ 1:1 USD ($1.00 USD) पर आंकी गई है",
    coinUsdtName: "Tether (USDT)",
  ...
  zh: {
    ...
    step1Title: "1. 平台官方 USDT 充值网络",
    step2Title: "2. 选择充值档位与胜率能量",
    step3Title: "3. 通过专属充值地址转账",

    coinSelectorTitle: "平台官方充值币种：",
    coinSelectorSubtitle: "USDT 与美元严格 1:1 锚定（$1.00 USD），无任何汇率滑点",
    coinUsdtName: "Tether (USDT)",
